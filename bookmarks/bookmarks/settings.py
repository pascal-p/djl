...
SECRET_KEY = os.environ.get("DJANGO_PROJECT2_SECRET_KEY", "arr gh hhh!! no..")
...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': 'bookmarks_db',
        'USER': os.environ.get("DJANGO_PROJECT2_DB_USER", "bookmark _user"),
        'PASSWORD': os.environ.get("DJANGO_PROJECT2_DB_PWD", ""),
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
